...
public class ProgramMemory_ATmega328P implements ProgramMemory {
   ...
   // private Handler ucHandler;
    ...
    public ProgramMemory_ATmega328P() {
    ...
    public boolean loadProgramMemory( String hexFileLocation) {
        ...
        System.out.println("HEX"+ "Loading from " + hexFileLocation.toString());
      ...
      //  if (Environment.MEDIA_MOUNTED.equals(state) || Environment.MEDIA_MOUNTED_READ_ONLY.equals(state)) {
            try {
            	...
            	File file = new File(hexFileLocation );
...
//                }
               ...
               /* String hexPath = PathUtil.getPath(context, hexFileLocation);
            	...
            	System.out.println(UCModule.MY_LOG_TAG+ "ERROR: Load file error");
                e.printStackTrace();
            }
       // } else {
    ...
    private void startCodeObserver(String hexFile) {
...
//        Log.d(UCModule.MY_LOG_TAG, "Loading instruction -> PC: " + (int) pcPointer);
        ...
        //System.out.println("prog pointer: " + (long)pcPointer);
        ...
        try {
            while ((line = reader.readLine()) != null) {
                ...
                try {
                    ...
                    System.out.println(UCModule.MY_LOG_TAG+ "ERROR: Something wrong while parsing this line:  " + line+ e);
                    continue;
                }
             //   System.out.println(UCModule.MY_LOG_TAG+ line);
                ...
                if (!checksum(readBytes)) {
                	System.out.println(UCModule.MY_LOG_TAG+ "Checksum error !!!");
                    return false;
                }

                dataSize = readBytes[INTEL_DATA_SIZE];
              //  System.out.println(UCModule.MY_LOG_TAG+ "Data size: " + dataSize);

                switch (readBytes[INTEL_REORD_TYPE]) {
                    //Data
                    case 00:
                    //	System.out.println(UCModule.MY_LOG_TAG+ "Loading Data from hex");
                    ...
                    //    System.out.println(UCModule.MY_LOG_TAG+ "Memory position: " + memoryPosition);

                        for (int i = 0; i < dataSize; i++) {
                            flashMemory[memoryPosition + i] = readBytes[INTEL_DATA + i];
                    //        System.out.println(UCModule.MY_LOG_TAG+ String.format("Added " + readBytes[INTEL_DATA + i] + " to flash"));
                        }
                    ...
                    //End of File
                    case 01:
                    	System.out.println(UCModule.MY_LOG_TAG+ "End of File from hex");
                        break;

                    //Extended Segment Address
                    case 02:
                    	System.out.println(UCModule.MY_LOG_TAG+ "Extended Segment Address from hex");
                        ...
                        System.out.println(UCModule.MY_LOG_TAG+ "Extended by: " + extendedAddress);
                        break;

                    //Extended Linear Address
                    case 04:
                    	System.out.println(UCModule.MY_LOG_TAG+ "Extended Linear Address from hex");
                    ...
                    default:
                    	System.out.println(UCModule.MY_LOG_TAG+ "Record Type unknown: " +
        	...
        	System.out.println(UCModule.MY_LOG_TAG+ "ERROR: Load .hex file"+ e);
            return false;
        } catch (ArrayIndexOutOfBoundsException e) {
        	System.out.println(UCModule.MY_LOG_TAG+ "ERROR: .hex file bigger than 32kB"+ e);
            return false;
        }
...
//        contentResolver.unregisterContentObserver(codeObserver);
    ...
    /*private class CodeObserver extends ContentObserver {
        ...
        public void onChange(boolean selfChange) {
            ...
            System.out.println(UCModule.MY_LOG_TAG+ "CodeObserver: File Changed - reseting simulator");
          //  ucHandler.sendEmptyMessage(UCModule.RESET_ACTION);
        }
    }*/
}
