...
public class DataMemory_ATmega328P implements DataMemory {
  ...
  //  private Handler pinHandler;
    ...
    public DataMemory_ATmega328P(IOModule ioModule) {//(IOModule ioModule) {
    ...
    public void stopTimer() {
        try {
            ...
            System.out.println(UCModule.MY_LOG_TAG + "ERROR: Timer not running "+ e);
        }
    }

    private void initDefaultContent() {
        System.out.println("Config" + "Configuring Memory");
         ...
         /*   UCModule_View.screenUpdater.post(new Runnable() {
                ...
                public void run() {
                    ...
                    //    MemoryFragment.mAdapter.notifyDataSetChanged();
                        ...
                        System.out.println(UCModule.MY_LOG_TAG + "ERROR: update memory map" + e);
                    }
                }
            });*/
        }
...
//            new Notify(this).execute((long) byteAddress,UCModule_View.simulatedTime);
    ...
    public synchronized void writeIOBit(int byteAddress, int bitPosition, boolean bitState) {
        //commented in the original
    	//        System.out.println(UCModule.MY_LOG_TAG,
...
//                        + " position: " + bitPosition + " state: " + ((0x01 & (sdramMemory[byteAddress] >> bitPosition)) != 0));
    ...
    // NOT NOT NOT commented in the original
    ...
    //    Message ioMessage;
    	Map<String, Object> message;
            switch (byteAddress) {
                ...
                case PORTB_ADDR:
                	 message = new HashMap<>();
                 	message.put(IOModule.CONFIG_IOMESSAGE, readIOByte(DDRB_ADDR));
                 	message.put(IOModule.VALUE_IOMESSAGE, readIOByte(PORTB_ADDR));
                 	message.put(IOModule.TIME, simulatedTime);
                 	message.put("what", IOModule.PORTB_EVENT);
...
//
             //       pinHandler.dispatchMessage(ioMessage);
                 	ioModule.handleMessage(message);
                    break;
                ...
                case PORTC_ADDR:
                	 ...
                	 message = new HashMap<>();
                	message.put(IOModule.CONFIG_IOMESSAGE, readIOByte(DDRC_ADDR));
                	message.put(IOModule.VALUE_IOMESSAGE, readIOByte(PORTC_ADDR));
                	message.put(IOModule.TIME, simulatedTime);
                	message.put("what", IOModule.PORTC_EVENT);
            /*        ioMessage = new Message();
              ...
              //      ioBundle.putLong(IOModule.TIME, simulatedTime);
                ...
                case PORTD_ADDR:
                	 ...
                	 message = new HashMap<>();
                	message.put(IOModule.CONFIG_IOMESSAGE, readIOByte(DDRD_ADDR));
                	message.put(IOModule.VALUE_IOMESSAGE, readIOByte(PORTD_ADDR));
                	message.put(IOModule.TIME, simulatedTime);
                	message.put("what", IOModule.PORTD_EVENT);
               /*     ioMessage = new Message();*/
...
////            System.out.println(UCModule.MY_LOG_TAG, String.format("Notify Address: 0x%s",
...
//
//            } catch (NullPointerException e){
//                System.out.println(UCModule.MY_LOG_TAG, "Norify (DataMemory) null reference", e);
//            }
//
//
//            return null;
...
//            //        System.out.println(UCModule.MY_LOG_TAG, String.format("Nority IO Address: 0x%s",
