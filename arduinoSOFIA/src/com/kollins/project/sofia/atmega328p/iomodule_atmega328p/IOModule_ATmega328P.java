...
public class IOModule_ATmega328P implements IOModule {//  extends Handler implements IOModule {
   ...
   // private static UCModule.UCHandler uCHandler;
    public OutputFragment_ATmega328P outputFragment;
   ...
   public OutputFragment_ATmega328P getOutputFragment(){ return outputFragment;};
   
   
   @Override
       public void handleMessage(Map  message){//Message msg) {

        List<OutputPin_ATmega328P> outputPins = outputFragment.getOutputPins();

        switch ((int)message.get("what")){//msg.what) {
            case PORTB_EVENT:

                valueRead_B = (byte)message.get(IOModule.VALUE_IOMESSAGE);//msg.getData().getByte(IOModule.VALUE_IOMESSAGE);
                configRead_B = (byte)message.get(IOModule.CONFIG_IOMESSAGE);//msg.getData().getByte(IOModule.CONFIG_IOMESSAGE);
                time_B = (long)message.get(IOModule.TIME);// msg.getData().getLong(IOModule.TIME);
               // System.out.println("time" + time_B);
            ...
            case PORTC_EVENT:
            	 ...
            	 valueRead_C = (byte)message.get(IOModule.VALUE_IOMESSAGE);//msg.getData().getByte(IOModule.VALUE_IOMESSAGE);
                 configRead_C = (byte)message.get(IOModule.CONFIG_IOMESSAGE);//msg.getData().getByte(IOModule.CONFIG_IOMESSAGE);
                 time_C = (long)message.get(IOModule.TIME);// msg.getData().getLong(IOModule.TIME);
               //  System.out.println("time" + time_C);
            ...
            case PORTD_EVENT:
            	 ...
            	 valueRead_D = (byte)message.get(IOModule.VALUE_IOMESSAGE);//msg.getData().getByte(IOModule.VALUE_IOMESSAGE);
                 configRead_D = (byte)message.get(IOModule.CONFIG_IOMESSAGE);//msg.getData().getByte(IOModule.CONFIG_IOMESSAGE);
                 time_D = (long)message.get(IOModule.TIME);// msg.getData().getLong(IOModule.TIME);
               //  System.out.println("time" + time_D);
...
//                Log.d("Freq", "Frequency: " + (Math.pow(10, 10) / (time - OutputFragment_ATmega328P.oldTime[OC0A_PIN_POSITION])));
          ...
          //  System.out.println("Updated OC0A");
        }
        ...
        try {
        	...
        	System.out.println(UCModule.MY_LOG_TAG + "ERROR: setOC0A (IOModule) -> output list is null" + e);
...
//                Log.d("Freq", "Frequency: " + (Math.pow(10, 10) / (time - OutputFragment_ATmega328P.oldTime[OC0B_PIN_POSITION])));
          ...
          //  System.out.println("Updated OC0B");
        }
...
System.out.println(UCModule.MY_LOG_TAG + "ERROR: setOC1B (IOModule) -> output list is null" + e);
...
//                Log.d("Freq", "Frequency: " + (Math.pow(10, 10) / (time - OutputFragment_ATmega328P.oldTime[OC2A_PIN_POSITION])));
        ...
        try {
        	...
        	System.out.println(UCModule.MY_LOG_TAG+ "ERROR: setOC2A (IOModule) -> output list is null"+ e);
...
System.out.println(UCModule.MY_LOG_TAG+ "ERROR: setOC2B (IOModule) -> output list is null"+ e);
        }
    }
...
//                    publishProgress(index);
            ...
            try {
            	...
            	System.out.println(UCModule.MY_LOG_TAG+ "ERROR: PortBUpdateView (doInBackground) -> output list is null"+ e);
...
//System.out.println("ASYNC_PORTC_UPDATE");
index = 0;
            //AN0 - AN5 (Pin14 - Pin19)
...
//                    publishProgress(index);
 //                   outputFragment.updateView(index);
            ...
            try {
            	...
            	System.out.println(UCModule.MY_LOG_TAG + "ERROR: PortCUpdateView (doInBackground) -> output list is null" + e);
         ...
         //           outputFragment.updateView(index);
            ...
            try {
              ...
              //  Log.e(UCModule.MY_LOG_TAG, "ERROR: PortDUpdateView (doInBackground) -> output list is null", e);
                System.out.println(UCModule.MY_LOG_TAG+ "ERROR: PortDUpdateView (doInBackground) -> output list is null"+ e);
            }
