...
import circuitArduino.UI.EditInfo;
	...
	protected void setPoints() {
	    super.setPoints();
	    int hs = sim.gridSize;
	    int heigth = (int)Math.round((double)(sim.gridSize)*3/2);
	    double f = (dn/2-hs/2)/dn;//(dn/2-4)/dn;
	    // calc leads
	    ...
	    interpPoint2(point1, point2, plate1[0], plate1[1], f, heigth);
	    interpPoint2(point1, point2, plate2[0], plate2[1], 1-f, heigth);
	}
	...
	protected void stamp() {
	    ...
	    sim.algorithm.stampResistor(nodes[0], nodes[1], compResistance);
	...
	protected void doStep() {
	    sim.algorithm.stampCurrentSource(nodes[0], nodes[1], curSourceValue);
 	}
