...
public class TransLineElm extends CircuitElm {
	...
	sim.algorithm.stampVoltageSource(nodes[4], nodes[0], voltSource1);
	sim.algorithm.stampVoltageSource(nodes[5], nodes[1], voltSource2);
	sim.algorithm.stampResistor(nodes[2], nodes[4], imped);
	sim.algorithm.stampResistor(nodes[3], nodes[5], imped);
    }
	...
	sim.algorithm.updateVoltageSource(nodes[4], nodes[0], voltSource1, -voltageR[ptr]);
	sim.algorithm.updateVoltageSource(nodes[5], nodes[1], voltSource2, -voltageL[ptr]);
