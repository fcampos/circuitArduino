...
import circuitArduino.UI.EditInfo;
  ...
  public  class TransformerElm extends CircuitElm {
	...
	protected void stamp() {
	    ...
	    a3 = -m*deti*ts;
	    a4 = l1*deti*ts;
	    sim.algorithm.stampConductance(nodes[0], nodes[2], a1);
	    sim.algorithm.stampVCCurrentSource(nodes[0], nodes[2], nodes[1], nodes[3], a2);
	    sim.algorithm.stampVCCurrentSource(nodes[1], nodes[3], nodes[0], nodes[2], a3);
	    sim.algorithm.stampConductance(nodes[1], nodes[3], a4);
	    sim.algorithm.stampRightSide(nodes[0]);
	    sim.algorithm.stampRightSide(nodes[1]);
	    sim.algorithm.stampRightSide(nodes[2]);
	    sim.algorithm.stampRightSide(nodes[3]);
	}
	...
	protected void doStep() {
	    sim.algorithm.stampCurrentSource(nodes[0], nodes[2], curSourceValue1);
	    sim.algorithm.stampCurrentSource(nodes[1], nodes[3], curSourceValue2);
 	}
