...
import circuitArduino.UI.EditInfo;
 ...
 public   class TappedTransformerElm extends CircuitElm {
	...
	protected void stamp() {
	    ...
	    for (i = 0; i != 9; i++)
		a[i] *= sim.timeStep/2;
	    sim.algorithm.stampConductance(nodes[0], nodes[1], a[0]);
	    sim.algorithm.stampVCCurrentSource(nodes[0], nodes[1], nodes[2], nodes[3], a[1]);
	    sim.algorithm.stampVCCurrentSource(nodes[0], nodes[1], nodes[3], nodes[4], a[2]);
	    
	    sim.algorithm.stampVCCurrentSource(nodes[2], nodes[3], nodes[0], nodes[1], a[3]);
	    sim.algorithm.stampConductance    (nodes[2], nodes[3], a[4]);
	    sim.algorithm.stampVCCurrentSource(nodes[2], nodes[3], nodes[3], nodes[4], a[5]);
	    
	    sim.algorithm.stampVCCurrentSource(nodes[3], nodes[4], nodes[0], nodes[1], a[6]);
	    sim.algorithm.stampVCCurrentSource(nodes[3], nodes[4], nodes[2], nodes[3], a[7]);
	    sim.algorithm.stampConductance    (nodes[3], nodes[4], a[8]);

	    for (i = 0; i != 5; i++)
		sim.algorithm.stampRightSide(nodes[i]);
	...
	protected void doStep() {
	    sim.algorithm.stampCurrentSource(nodes[0], nodes[1], curSourceValue[0]);
	    sim.algorithm.stampCurrentSource(nodes[2], nodes[3], curSourceValue[1]);
	    sim.algorithm.stampCurrentSource(nodes[3], nodes[4], curSourceValue[2]);
 	}
